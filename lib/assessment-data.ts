...
export const ANXIETY_PROFILES: Record<string, AnxietyProfile> = {
  survival: {
    ...
    subtitle: '現實壓力高',
    description:
      '您的焦慮主要來自當下真實的生活壓力——收入、帳單、日常開銷。\n\n這種焦慮有其現實基礎，但長期處於高壓狀態會讓您身心俱疲，影響判斷力與行動力。',
    relatable:
      '每個月領薪水的那天心情最好，但沒過幾天錢包又空了。\n\n看到超市收據、加油金額、水電帳單，心頭就會突然一緊。\n\n你不是不努力，只是總感覺錢永遠不夠用，生活的重量讓你喘不過氣。',
    recommendations: [
      '列出所有必要開支，清楚掌握每月資金缺口',
  ...
  anticipation: {
    ...
    subtitle: '不確定恐懼高',
    description:
      '您的焦慮主要來自對未來不確定性的高度恐懼。\n\n您傾向於預想最壞的情境，即使目前尚未發生，這種「萬一」思維會讓您持續處於緊繃狀態，難以享受當下的平靜。',
    relatable:
      '你最怕的不是現在，而是那個「萬一」。\n\n萬一突然生病、萬一車子壞了、萬一要換工作……一個尚未發生的場景就能讓你夜裡輾轉難眠。\n\n你不是杞人憂天，你只是太想保護自己不被突如其來的事情擊垮。',
    recommendations: [
  ...
  helplessness: {
    ...
    subtitle: '掌控感低',
    description:
      '您感到自己對財務狀況缺乏掌控力，即使知道問題所在，也不知從何改變起。\n\n這種無力感不是能力不足，而是長期挫折或資訊不足所累積的心理阻礙。',
    relatable:
  ...
  avoidance: {
    ...
    subtitle: '行為退縮',
    description:
      '您面對財務問題時容易陷入迴避與拖延，帳單不打開、問題不面對，用「之後再說」保護自己免於當下的焦慮。\n\n但這種模式往往讓問題在暗處越滾越大。',
    relatable:
      '信用卡帳單還沒打開就先放到抽屜，貸款的事「之後再說」。\n\n明明知道問題就在那裡，卻總覺得不面對好像就不存在。\n\n你不是不負責任，你只是太害怕打開那扇門之後會看到什麼。',
    recommendations: [
  ...
  hypervigilance: {
    ...
    subtitle: '完美主義傾向',
    description:
      '您對財務細節高度敏感，對自己的金錢管理有嚴格標準，稍有偏差就陷入自責。\n\n這種完美主義的背後是對失控的深層恐懼，反而讓您無法輕鬆地和金錢相處。',
    relatable:
      '你可能是朋友眼中的「理財達人」，但沒有人知道你每天花多少時間反覆核對帳戶。\n\n多花了一杯咖啡錢，就能讓你自責半天。\n\n你不是吝嗇，你只是太害怕一個小錯誤會讓一切崩塌。',
    recommendations: [
